                  ...
                  background: FadeIn(
                    ...
                    ShaderMask(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl: ApiConstance.imageUrl(cubit.movieDetail!.backdropPath),
                        fit: BoxFit.cover,
                      ),
                    )
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Text(
                                cubit.movieDetail!.releaseDate.split('-')[0],
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  (cubit.movieDetail!.voteAverage / 2).toStringAsFixed(1),
                                  style: const TextStyle(
                                    fontSize: 16.0,
                                    fontWeight: FontWeight.w500,
                                    letterSpacing: 1.2,
                            ...
                            const SizedBox(width: 16.0),
                            Text(
                              _showDuration(cubit.movieDetail!.runtime),
                              style: const TextStyle(
